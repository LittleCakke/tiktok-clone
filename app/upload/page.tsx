...
import type { UploadError } from "@/app/types";
            ...
            return (
                <div
                    ...
                    <div
                        ...
                        gap-1">
                        <BiLoaderCircle
                            className="animate-spin text-[#F12B56]"
                            size={30} />
                        <div
        ...
        if (!fileDisplay)
        {
            return (
                <label
                    ...
                    <p
                        className="mt-1.5 text-gray-500 text-[13px]">
                    ...
                    <p
                        className="mt-2 text-gray-400 text-[13px]">
                        Up to 30 minutes
                    </p>
    ...
    return (
        <UploadLayout>
            <div
                ...
                <div
                    className="mt-8 md:flex gap-6">
                    { isFileDisplay() }

                    <div
                        className="mt-4 mb-6">
                        <div
                            className="flex bg-[#F8F8F8] py-4 px-6">
                            <div>
                                <PiKnifeLight
                                    className="mr-4"
                                    size={20} />
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    multiple parts, remove redundant part
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <button
                                ...
                                bg-[#F02C56]
                                rounded-sm">
                                { isUploading ? <BiLoaderCircle className="animate-spin text-white" size={25} /> : "Post" }
                            </button>
                        </div>
